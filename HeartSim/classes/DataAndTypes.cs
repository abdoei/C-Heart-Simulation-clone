...
namespace HeartSim.classes.DataAndTypes
{
  ...
  public static class Data
  {
    ...
    {
      new List<int>{1, 1, 21, 10},
      new List<int>{1, 21, 2, 10},
      new List<int>{1, 30, 3, 5},
      new List<int>{1, 1, 4, 5},
      new List<int>{1, 33, 3, 5},
      new List<int>{1, 1, 8, 5},
      new List<int>{1, 8, 9, 10},
      new List<int>{1, 9, 10, 10},
      new List<int>{1, 3, 5, 2},
      new List<int>{1, 5, 6, 2},
      new List<int>{1, 6, 7, 2},
      new List<int>{1, 7, 11, 2},
      new List<int>{1, 7, 13, 2},
      new List<int>{1, 11, 12, 2},
      new List<int>{1, 13, 14, 2},
      new List<int>{1, 12, 15, 10},
      new List<int>{1, 14, 16, 10},
      new List<int>{1, 15, 16, 10},
      new List<int>{1, 15, 17, 10},
      new List<int>{1, 16, 19, 10},
      new List<int>{1, 17, 18, 10},
      new List<int>{1, 19, 20, 10},
      new List<int>{1, 1, 22, 10},
      new List<int>{1, 22, 23, 10},
      new List<int>{1, 24, 25, 10},
      new List<int>{1, 15, 24, 10},
      new List<int>{1, 26, 27, 10},
      new List<int>{1, 16, 26, 10},
      new List<int>{1, 27, 28, 10},
      new List<int>{1, 23, 29, 5},
      new List<int>{1, 31, 30, 10},
      new List<int>{1, 4, 31, 10},
      new List<int>{1, 4, 32, 10},
      new List<int>{1, 32, 33, 10},
    };
    ...
    public static readonly List<List<int>> ProbeIntParameters = new List<List<int>>
    {
      ...
      new List<int>{24, 25},
      new List<int>{24, 25},
      new List<int>{10, 24, 25},
      new List<int>{24, 25},
      new List<int>{14, 16, 19, 26},
      new List<int>{14, 26},
      new List<int>{14, 26},
      new List<int>{14, 26},
    };
